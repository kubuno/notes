...
All notable changes to **kubuno-notes** are documented in this file.
...
- **Notes now authenticates proxied requests from a signed token instead of trusting plain headers.** Requests must carry a valid `X-Kubuno-Auth` token minted by the core with this module's internal secret (see `kubuno-modauth`), rather than reading `X-Kubuno-User-*` headers at face value.
...
[Unreleased]: https://github.com/kubuno/notes/compare/v0.1.8...HEAD
[0.1.8]: https://github.com/kubuno/notes/releases/tag/v0.1.8
[0.1.7]: https://github.com/kubuno/notes/releases/tag/v0.1.7
[0.1.6]: https://github.com/kubuno/notes/releases/tag/v0.1.6
