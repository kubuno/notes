...
#   /usr/lib/kubuno/modules/notes/{kubuno-notes, module.toml, frontend/}
#   /usr/share/kubuno/modules/notes/migrations/*.sql
#   /etc/kubuno/modules/notes/config.toml.example
#
# Usage :
